...
public class Bullet : MonoBehaviour
{
    ...
    {
        if(_targetEnemy != null)//jika ada enemy 
        {
            if (!_targetEnemy.gameObject.activeSelf)//jika bullet tidak mengejar enemy maka set game objek false
            {
